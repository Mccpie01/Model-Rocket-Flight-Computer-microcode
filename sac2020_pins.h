...
#define PIN_LED_PYRO1_FAULT -1
#define PIN_LED_PYRO2_FAULT -1
#define PIN_LED_PYRO3_FAULT -1
#define PIN_LED_PYRO4_FAULT -1
#define PIN_LED_PYRO5_FAULT -1
#define PIN_LED_PYRO6_FAULT -1
